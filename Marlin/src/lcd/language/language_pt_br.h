...
namespace Language_pt_br {
  ...
  PROGMEM Language_Str MSG_DISABLE_STEPPERS                = _UxGT("Desabilitar motores");
  PROGMEM Language_Str MSG_DEBUG_MENU                      = _UxGT("Menu debug");
  PROGMEM Language_Str MSG_PROGRESS_BAR_TEST               = _UxGT("Teste barra progres");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_DONE                  = _UxGT("Mesa nivelada");
  ...
  PROGMEM Language_Str MSG_PREHEAT_1                       = _UxGT("Preaquecer ") PREHEAT_1_LABEL;
  PROGMEM Language_Str MSG_PREHEAT_1_H                     = _UxGT("Preaquecer ") PREHEAT_1_LABEL " ~";
  ...
  PROGMEM Language_Str MSG_PREHEAT_1_ALL                   = _UxGT("Geral ") PREHEAT_1_LABEL;
  ...
  PROGMEM Language_Str MSG_PREHEAT_2                       = _UxGT("Preaquecer ") PREHEAT_2_LABEL;
  PROGMEM Language_Str MSG_PREHEAT_2_H                     = _UxGT("Preaquecer ") PREHEAT_2_LABEL " ~";
  ...
  PROGMEM Language_Str MSG_PREHEAT_2_ALL                   = _UxGT("Geral ") PREHEAT_2_LABEL;
  ...
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("Customizar Preaq.");
  ...
  PROGMEM Language_Str MSG_HOTEND_OFFSET_X                 = _UxGT("Bico 2 X");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Y                 = _UxGT("Bico 2 Y");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Z                 = _UxGT("Bico 2 Z");
  ...
  PROGMEM Language_Str MSG_UBL_MESH_LEVELING               = _UxGT("Nivelamento da Malha");
  ...
  PROGMEM Language_Str MSG_LOAD_EEPROM                     = _UxGT("Ler config.");
  PROGMEM Language_Str MSG_RESTORE_DEFAULTS                = _UxGT("Restaurar padrão");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_UNLOAD   = _UxGT("RETRAIR FILAMENTO");
